      ...
      <div className="max-w-6xl mx-auto w-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="text-center">
            <div className="w-16 h-16 bg-[#B08D57]/20 rounded-full flex items-center justify-center mx-auto mb-4">
        ...
        <div className="mt-12 text-center">
          <a 
            href="/contact"
            className="inline-block border border-[#B08D57] text-[#B08D57] px-8 py-3 text-sm tracking-widest uppercase hover:bg-[#B08D57] hover:text-white transition-colors"
          >
            Send Us a Message
          </a>
        </div>
